...
import io.github.kloping.mywebsite.entitys.webApi.ks.KsSearchEn;
import io.github.kloping.mywebsite.entitys.webApi.ks.Variables;
import io.github.kloping.mywebsite.entitys.webApi.ks.response.Feeds;
import io.github.kloping.mywebsite.entitys.webApi.ks.response.KsSearchResponse;
...
@Service
public class SearchVideoGiftshow implements ISearchVideo {

    private static final String BASE_URL = "https://www.kuaishou.com/graphql";
