...
@Service
public class SearchVideo_Bili implements ISearchVideo {
    ...
    public VideoSource search(String keyword) throws Exception {
        ...
        for (int i = 0; i < size; i++) {
            ...
            MyUtils.threads.execute(() -> {
                ...
                try {
                    ss = getVIUrlFromBvId(jo.getString("bvid"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private static String[] getVIUrlFromBvId(String id) throws Exception {
