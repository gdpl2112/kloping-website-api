...
public class Grp {
	...
	public Grp setFiurl(String fiurl) {
		this.fiurl = fiurl;
		return this;
	}
	...
	public Grp setLyric_hilight(String lyric_hilight) {
	...
	public Grp setPubTime(Number pubTime) {
	...
	public Grp setFnote(Number fnote) {
		this.fnote = fnote;
		return this;
	}
	...
	public Grp setPure(Number pure) {
		this.pure = pure;
		return this;
	}
	...
	public Grp setChinesesinger(Number chinesesinger) {
	...
	public Grp setAlbumName_hilight(String albumName_hilight) {
	...
	public Grp setSongName_hilight(String songName_hilight) {
	...
	public Grp setFsinger(String fsinger) {
	...
	public Grp setIsweiyun(Number isweiyun) {
	...
	public Grp setOnly(Number only) {
		this.only = only;
		return this;
	}
	...
	public Grp setSingerName2_hilight(String singerName2_hilight) {
	...
	public Grp setFsinger2(String fsinger2) {
	...
	public Grp setSingerMID(String singerMID) {
	...
	public Grp setSingerName_hilight(String singerName_hilight) {
	...
	public Grp setDocid(String docid) {
		this.docid = docid;
		return this;
	}
	...
	public Grp setIsupload(Number isupload) {
	...
	public Grp setFsong(String fsong) {
		this.fsong = fsong;
		return this;
	}
	...
	public Grp setSingerMID2(String singerMID2) {
	...
	public Grp setSingerid(Number singerid) {
	...
	public Grp setLyric(String lyric) {
		this.lyric = lyric;
		return this;
	}
	...
	public Grp setSingerid2(Number singerid2) {
