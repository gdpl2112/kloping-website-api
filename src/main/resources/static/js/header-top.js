$("body").append("\n" +
    "<nav style='opacity: 0.7;border: 1px solid #01b1c7;' class=\"fixed-top navbar navbar-expand-lg navbar-light bg-light\">\n" +
    ...
    "            <a href=\"./recharge.html\"> <button class=\"btn btn-outline-success my-2 my-sm-0\" type=\"button\">积分充值</button>\n" +
    "            </a>        </form>\n" +
    "    </div>\n" +
    "</nav>");
